...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/08/15 10:16:56 by cudoh             #+#    #+#             */
/*   Updated: 2022/08/15 10:16:56 by cudoh            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief 	This function checks that user input is correct
 * 
 * @param arg_cnt 
 * @param argv_str 
 * @return int 
...
int	ft_check_usr_inp(int arg_cnt, char **argv_str)
{
	...
	pid = ft_atoi(argv_str[1]);
	if (kill(pid, 0) < 0)
	{
		ft_printf("Error: Process does not exist\n");
		return (-1);
	}
	ft_send_string(argv_str[2], pid);
	return (0);
}
